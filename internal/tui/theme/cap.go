...
// CAPTheme implements the Theme interface with CAP brand colors.
// It provides both dark and light variants.
type CAPTheme struct {
	BaseTheme
}

// NewCAPTheme creates a new instance of the CAP theme.
...
func init() {
	// Register the CAP theme with the theme manager
	RegisterTheme("cap", NewCAPTheme())
}
